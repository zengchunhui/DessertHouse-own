	...
	$.ajax({
                ...
                success:function(result,textStatus){
                    	...
                    	$("#plan-table").append("<tr>"+
                    		...
                    		"<td>"+p_name+"</td>"+
                    		"<td><input type=\"text\" id=\""+result.p_id+"-num\" value=\""+p_num+"\"></td>"+
                    		"<td><input type=\"text\" id=\""+result.p_id+"-price\" value=\""+price+"\"></td>"+
                    		"<td><a class=\"plan-btn-edit\" id=\""+result.p_id+"-edit\"><imgsrc=\"../img/edit.png\"></a></td>"+
                    		"<td><a class=\"plan-btn-delete\" id=\""+result.p_id+"-delete\"><imgsrc=\"../img/delete.png\"></a></td>"+
                    		"</tr>");
                }
            });
});